...
@section('content')
    <div class="full-row pt-0">
        <div class="container">
            <div class="row">
                <div class="col-lg-2">
                    <div id="sidebar" class="widget-title-bordered-full d-none d-md-block">
                        <form action="{{ request()->fullUrl() }}" id="filter">
                ...
                <div class="col-lg-10">
                    <div class="border-bottom-gray pb-2">
                        <p class="d-inline ms-2">
                            مرتب سازی براساس:
                        </p>
                        <br class="d-block d-md-none">
                        <button type="submit" form="filter" name="order" value="new" class="ms-4 {{ (request()->order == 'new') || is_null(request()->order) ? 'text-primary fw-bolder' : 'text-light' }}">
                            جدیدترین
                        </button>
                        <button type="submit" form="filter" name="order" value="popular" class="ms-4 {{ request()->order == 'popular' ? 'text-primary fw-bolder' : 'text-light' }}">
                            مجبوب‌ترین
                        </button>
                        <button type="submit" form="filter" name="order" value="sold" class="ms-4 {{ request()->order == 'sold' ? 'text-primary fw-bolder' : 'text-light' }}">
                            پرفروش‌ترین
                        </button>
                    </div>
                    ...
                    <!-- modal for filters  -->
                      ...
                      <div class="modal fade" id="filter-modal" tabindex="-1" role="dialog" aria-labelledby="searchModal" aria-hidden="true">
