(function($) {
    ...
    */
    ...
    $('[class*="swatch-filter-"]').each(function() {
        ...
        if (count > 5) {
            $(this).append('<div class="maxlist-more"> <span>+ مشاهده موارد بیشتر</span><span>- بستن</span></div>');
        }
    });
    ...
    if ($single_carousel.length) {
        $single_carousel.owlCarousel({
            ...
            margin: 30,
            nav: true,
            navText: ["<div class='nav-btn prev-slide'><i class='fas fa-chevron-left'></i><span>قبل</span></div>", "<div class='nav-btn next-slide'><span>بعد</span><i class='fas fa-chevron-right'></i></div>"],
            dots: true,
            smartSpeed: 500,
            autoplay: false,
            responsive: {
    ...
    $('[data-countdown]').each(function() {
        ...
        $this.countdown(finalDate, function(event) {
            $this.html(event.strftime('<ul><li><span>%D</span><span>روز</span></li> <li><span>%H</span><span>ساعت</span></li> <li><span>%M</span><span>دقیقه</span></li> <li><span>%S</span><span>ثانیه</span></li></ul>'));
        });
    });
